...
function hardcodedAI_lvl_04(_game, _playerSelf, _playerOther) constructor
{
	game = _game
	...
	function ModeDefensive()
	{
		...
		else
		{
			...
			mytargetdir = my_direction_from_center + (90 + own_speed*4 + outwards_percentage*50) * sign(angle_diff)
