...
function hardcodedAI_lvl_06(_game, _playerSelf, _playerOther) constructor
{
	game = _game
	...
	function ModeCampCenter()
	{
		...
		SetOutputsToAchieveTargetVelocity(point_direction(0, 0, xoutput, youtput), enemyspeed+2)
	}
