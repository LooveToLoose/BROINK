...
function hardcodedAI_lvl_01(_game, _playerSelf, _playerOther) constructor
{
	game = _game
	...
	function Step()
	{
		xoutput = -playerSelf.xpos / 10
		youtput = -playerSelf.ypos / 10
		xoutput += -playerSelf.xspeed * 0.2
		youtput += -playerSelf.yspeed * 0.2
	}
	...
	function OutOfBoundsEmergencyBreak()
	{
		...
		var fakeradius = game.game_radius - 100
